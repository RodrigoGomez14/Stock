  ...
  const NuevoProveedor=(props)=>{
    ...
    useEffect(()=>{
        if(props.history.location.search){
            const {nombre,dni,cuit,expresos,mails,direcciones,telefonos,infoExtra,deuda} = props.proveedores[props.history.location.search.slice(1)].datos
                ...
                <Grid container justify='center'>
                    <Paper elevation={6}>
                        ...
                        <Button variant='contained'  onClick={guardarDatos} className={classes.button}>
                            {props.history.location.search?'Guardar Edicion':'Guardar Proveedor'}     
                        </Button>
                    </Paper>
                </Grid>
            )}
                    ...
                    <Snackbar open={showSnackbar} autoHideDuration={2000} onClose={()=>{setshowSnackbar(false)}}>
                        <Alert onClose={()=>{setshowSnackbar(false)}} severity="success" variant='filled'>
                            {props.history.location.search?
                                ...
                                :
                                'El nuevo proveedor ha sido agregado!'
                            }
                        </Alert>
                    </Snackbar>
                    :
